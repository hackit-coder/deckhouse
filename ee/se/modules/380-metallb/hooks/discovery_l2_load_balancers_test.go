...
var _ = Describe("Metallb :: hooks :: discovery_l2_lb ::", func() {
	...
	Context("3 services, 2 MLBC, 3 nodes", func() {
		BeforeEach(func() {
			f.BindingContexts.Set(f.KubeStateSet(`
---
apiVersion: v1
...
metadata:
  ...
  namespace: nginx1
  annotations:
    network.deckhouse.io/l2-load-balancer-ips: 3.3.3.3
    network.deckhouse.io/l2-load-balancer-external-ips-count: "2"
spec:
  clusterIP: 2.3.4.5
  ports:
...
metadata:
  ...
  namespace: nginx2
  annotations:
    network.deckhouse.io/l2-load-balancer-ips: 1.1.1.1,2.2.2.2
